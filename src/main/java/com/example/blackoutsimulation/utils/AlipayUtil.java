...
import com.example.blackoutsimulation.alipay.config.Configs;
import com.example.blackoutsimulation.alipay.model.ExtendParams;
import com.example.blackoutsimulation.alipay.model.GoodsDetail;
import com.example.blackoutsimulation.alipay.model.builder.*;
import com.example.blackoutsimulation.alipay.model.hb.*;
...
import com.example.blackoutsimulation.alipay.service.AlipayMonitorService;
import com.example.blackoutsimulation.alipay.service.AlipayTradeService;
import com.example.blackoutsimulation.alipay.service.impl.AlipayMonitorServiceImpl;
import com.example.blackoutsimulation.alipay.service.impl.AlipayTradeServiceImpl;
import com.example.blackoutsimulation.alipay.service.impl.AlipayTradeWithHBServiceImpl;
import com.example.blackoutsimulation.alipay.utils.Utils;
import com.example.blackoutsimulation.alipay.utils.ZxingUtils;
import com.example.blackoutsimulation.controller.DemoHbRunner;
...
//        AlipayUtil main = new AlipayUtil();
//
//        // 系统商商测试交易保障接口api
...
//    }
    ...
    // 测试系统商交易保障调度
    public static void test_monitor_schedule_logic() {
        // 启动交易保障线程
    ...
    public static void test_monitor_pos() {
    ...
    // 测试当面付2.0生成支付二维码
    public static JSONObject test_trade_precreate() throws IOException, WriterException {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 将返回的二维码存储至本地
                String path = "E:\\code\\" +UUID.randomUUID().toString()+ "AliPay.jpg";
                String filePath = String.format(path, response.getOutTradeNo());
                log.info(ZxingUtils.getQRCodeImge(res.getQrCode(), 256, filePath));
